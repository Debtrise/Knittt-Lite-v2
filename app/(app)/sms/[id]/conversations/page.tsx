      ...
      <div className="py-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Button
                variant={showUnreplied ? "brand" : "secondary"}
                ...
                <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md">
                    ...
                    <form onSubmit={handleSendBulkReply}>
                        ...
                        <div className="flex justify-end space-x-3">
                            ...
                            <Button type="submit" variant="brand" isLoading={isSendingBulkReply} disabled={!bulkReplyMessage.trim() || isSendingBulkReply}>
                                Send Bulk Reply
                            </Button>
                        </div>
                    </form>
                  ...
                  <button onClick={() => setSelectedContact(contact)} className="w-full text-left flex items-center">
                    ...
                    <div className="ml-3 flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        ...
                        {typeof contact.unreadCount === 'number' && contact.unreadCount > 0 && !selectedContact && (
              ...
              <>
                ...
                <div className="p-4 border-t">
                  <form onSubmit={handleSendMessage} className="flex space-x-3 items-center">
                    ...
                    <Button type="submit" variant="brand" disabled={!newMessage.trim() || isSending} isLoading={isSending} size="icon" className="p-2">
